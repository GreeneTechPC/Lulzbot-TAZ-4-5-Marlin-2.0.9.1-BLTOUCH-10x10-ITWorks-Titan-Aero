...
#define STRING_CONFIG_H_AUTHOR "(GreeneTech, TAZ 5 BLTouch)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 0  // If board has been retrofitted with Archim use -1 here. Otherwise leave at 0
...
#define CUSTOM_MACHINE_NAME "GreeneTech TAZ"
 ...
 */
#define Z_MIN_PROBE_PIN SERVO0_PIN // Digital pin 22
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25, 0, -8 }
